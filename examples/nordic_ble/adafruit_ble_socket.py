...
# Original Work Copyright (c) 2019 ladyada, esp32spi_socket
# Modified Work Copyright (c) 2021 Tasm-Devil, nordic UART
...
* Author(s): ladyada, Tasm-Devil

Implementation Notes
--------------------

Adapted from Adafruit_CircuitPython_ESP32SPI/blob/main/adafruit_esp32spi/adafruit_esp32spi_socket.py
